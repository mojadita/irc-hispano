...
public enum IRCCode {
	...
	// requests
	PASS(new IRCCode[]{ERR_NEEDMOREPARAMS, ERR_ALREADYREGISTERED}),//ok
	NICK(new IRCCode[]{ERR_NONICKNAMEGIVEN, ERR_ERRONEUSNICKNAME, 
			ERR_NICKNAMEINUSE, ERR_NICKCOLLISION, ERR_UNAVAILRESOURCE,
			ERR_RESTRICTED}),//ok
	USER(new IRCCode[]{ERR_NEEDMOREPARAMS, ERR_ALREADYREGISTERED}),//ok
	SERVER,
	SERVICE(new IRCCode[]{ERR_ALREADYREGISTERED, ERR_NEEDMOREPARAMS,
			ERR_ERRONEUSNICKNAME, RPL_YOURESERVICE, RPL_YOURHOST, RPL_MYINFO}),//ok
	...
	TOPIC(new IRCCode[]{ERR_NEEDMOREPARAMS, ERR_NOTONCHANNEL,
           ...
           ERR_CHANOPRIVSNEEDED,            ERR_NOCHANMODES}),//ok
