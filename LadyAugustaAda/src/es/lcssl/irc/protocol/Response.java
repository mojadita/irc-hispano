 ...
 *
 */
public class Response extends BasicMessage {
	 ...
	 * @param code the message {@link ResponseCode}.
	 * @param params the {@link Collection} of {@link String}s that compose the
	 * parameter list.
	 */
	public Response(Origin origin, ResponseCode code, Collection<String> params) {
		super(origin, params);
		m_code = code;
	}
	 ...
	 */
	public Response(Origin origin, ResponseCode code, String... params) {
		super(origin, params);
		m_code = code;
	}
	 ...
	 * 
	 * @see {@link Response#Request(Origin, ResponseCode, Collection)}
	 * @param code the message {@link ResponseCode}.
	 * @param params the parameter list as a {@code {@link Collection}<{@link String}>}.
	 */
	public Response(ResponseCode code, Collection<String> params) {
		super(params);
		m_code = code;
	}
	 ...
	 * Non {@link Origin} constructor.
	 * 
	 * @see Response#Request(Origin, ResponseCode, String...)
	 * @param code the message {@link ResponseCode}.
	 * @param params the parameter list as a {@code {@link String}[]}.
	 */
	public Response(ResponseCode code, String... params) {
		super(params);
		m_code = code;
	}
	 ...
	 * @return the {@code ResponseCode} value of the 
	 * property {@code code}
	 */
